...
function theme_setup() {
	...
	*  sizes with add_image_size. */
	...
	add_image_size('post-image', 380,230,true);
	add_image_size('single-team-member',500, 370,true);
	add_image_size('single-post-image', 400,400,true);
...
wp_deregister_script('jquery');
 ...
 wp_localize_script('scripts', 'data', array(
	'message' => $last_name
));
  
  wp_enqueue_script(
	'fontAwesome',
	"http" . ($_SERVER['SERVER_PORT'] == 443 ? "s" : "") . "https://kit.fontawesome.com/740a9e10e2.js",
	false, //dependencies
	null, //version number
	true //load in footer
);
